        ...
        <div class="card">
            <div class="card-datatable table-responsive">
                <table class="datatables-users table border-top">
                    ...
                    <tbody>
                        @foreach ($careerInquiries as $contact)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $contact->name }}</td>
                                <td>{{ $contact->email }}</td>
                                <td>{{ $contact->phone }}</td>
                                <td>{{ $contact->desired_role }}</td>
                                <td>{{ $contact->link }}</td>
                                <td><a href="{{ asset($contact->cv) }}" target="_blank" rel="noopener noreferrer">View</a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="{{ route('admin.career-general-inquiry.delete', $contact->id) }}" class="btn btn-danger">
