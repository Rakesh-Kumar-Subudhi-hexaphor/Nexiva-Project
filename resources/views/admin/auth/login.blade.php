...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr"
    ...
    <head>
        ...
        <title>Nexiva Admin Login</title>
        ...
        <!-- Favicon -->
        {{-- <link rel="shortcut icon" type="image/x-icon" href="{{ asset('frontend/img/pkc-fav.png') }}"> --}}
    ...
    <body>
            ...
            <div class="authentication-inner row m-0">
                ...
                <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
                    <div class="w-100 d-flex justify-content-center">
                        <img src="{{ asset('assets/img/pages/SE login Page.png') }}" class="img-fluid"
        ...
        justify-content: center;">
                            <a href="index.html" class="app-brand-link gap-2">
                                {{-- <div>
                                <img src="{{asset('frontend/assets/img/logo/ora-logo.png')}}" style="height: 87px;"
                                    alt="">
                                <!-- <h1 style=" text-transform: uppercase;font-size: 27px;">Education</h1> -->
                            </div> --}}
