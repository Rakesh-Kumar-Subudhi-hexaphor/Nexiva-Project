<x-backend.app-layout>
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms/</span>Edit Industry Serve</h4>

        <div class="card mb-4">

            <form class="card-body" action="{{ route('admin.industry-serve.update', $industry->id) }}" method="POST"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6" id="title-section">
                        ...
                        <input type="text" id="product-name" name="title" class="form-control"
                            value="{{ old('title', $industry->title) }}" placeholder="Enter Title" />
                        @error('title')
                    ...
                    <div class="col-md-6" id="image-section">
                        ...
                        @enderror
                        @if ($industry->image)
                            <img src="{{ asset($industry->image) }}" alt="Current Image" class="mt-3"
                    ...
                    <div class="col-md-6" id="image-section">
                        ...
                        @enderror
                        @if ($industry->icon)
                            <img src="{{ asset($industry->icon) }}" alt="Current Icon" class="mt-3"
                                style="max-width: 100px;">
                        @endif
                    </div>
                    ...
                    <div class="col-md-6" id="source-section">
                        ...
                        <input type="text" id="product-name" name="short_desc" value="{{ $industry->short_desc }}"
                    ...
                    <div class="col-md-6" id="meta-title-section">
                        ...
                        <input type="text" id="meta_title" name="meta_title" class="form-control"
                            placeholder="Enter Meta Title" value="{{ $industry->meta_title }}" />
                        @error('meta_title')
                            <p class="text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6" id="meta-title-section">
                        ...
                        <input type="text" id="meta_desc" name="meta_desc" class="form-control"
                            placeholder="Enter Meta Description" value="{{ $industry->meta_desc }}" />
                        @error('meta_desc')
                            <p class="text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6" id="tags-section">
                        ...
                        <div id="tag-container" style="display: flex; flex-wrap: wrap;">
                            ...
                            @foreach (explode(',', $industry->tags) as $tag)
                                <div
                        ...
                        <input type="hidden" name="tags_hidden" value="{{ old('tags_hidden', $industry->tags ?? '') }}"
                            id="tagsHiddenInput">
                    ...
                    <div class="col-md-12" id="desc-section">
                        ...
                        <textarea name="description" class="form-control" id="description" cols="30" rows="10">{{ old('description', $industry->description) }}</textarea>
                        @error('description')
                            <p class="text-xs text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
