...
class PageController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.index', compact('sliders', 'services', 'solutions', 'casestudies', 'industries', 'collaborators', 'blogs', 'testimonials'));
    }
    ...
    public function casestudyDetail($slug)
    {
        ...
        $services = Service::whereIn('id', $casestudy->service)->pluck('title');
        return view('frontend.casestudy-detail', compact('casestudy', 'services'));
    }
    public function faq()
    {
